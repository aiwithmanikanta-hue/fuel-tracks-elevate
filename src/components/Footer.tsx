...
export function Footer() {
  return (
    <footer className="relative mt-24 border-t border-white/10 text-white [&_.text-muted-foreground]:text-white/70 [&_.text-foreground]:text-white" style={{ background: "linear-gradient(180deg, oklch(0.13 0.05 250), oklch(0.18 0.07 250))" }}>
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-16">
        <div className="grid gap-12 md:grid-cols-3">
          {/* Brand */}
          <div>
            <Link to="/" className="flex items-center gap-3 bg-white rounded-xl px-3 py-2 w-fit">
            ...
            <ul className="mt-4 space-y-3.5 text-sm text-muted-foreground">
              ...
              <li className="flex gap-2.5"><Phone className="size-4 mt-0.5 text-primary shrink-0" />
                <div>
                  ...
                  <a href="tel:+919491666914" className="block hover:text-primary">+91 94916 66914</a>
                </div>
              </li>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row gap-3 items-center justify-between text-xs text-muted-foreground">
      ...
      <div className="lg:hidden fixed bottom-3 inset-x-3 z-40 grid grid-cols-2 gap-2">
        <a href="tel:+917337433351" className="flex items-center justify-center gap-2 py-3 rounded-xl bg-[var(--gradient-primary)] text-primary-foreground font-semibold shadow-glow text-sm">
          <Phone className="size-4" /> Call Now
        </a>
        <a href="https://wa.me/917337433351" className="flex items-center justify-center gap-2 py-3 rounded-xl bg-[oklch(0.68_0.18_145)] text-white font-semibold shadow-elegant text-sm">
